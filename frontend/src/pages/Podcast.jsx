        ...
        {podcast.map((episode) => (
          ...
          >
            ...
            <div className="flex justify-center -mt-16">
              <div className="bg-white border-4 border-black rounded-lg p-2 mb-2">
                <img
            ...
            <div className="mt-4">
              <button
                ...
                className="bg-[#FDDC59] text-black font-bold px-6 py-3 rounded-full border-2 border-black shadow-md hover:bg-[#e6b722] transition"
