  ...
  return (
    <div className="flex flex-col bg-[#f5e5d0] min-h-screen relative pb-16">
      ...
      <div className="mx-auto max-w-6xl text-center ">
        <h2 className="text-4xl font-semibold tracking-tight text-balance text-[#1FA19C] sm:text-5xl" style={{fontFamily: "Jua, sans-serif", color: "#1FA19C"}}>Login</h2>
        <p className="mt-2 text-lg/8 text-gray-600"style={{fontFamily: "Roboto, sans-serif"}}>Login to your account to access your profile and settings.</p>
      </div>
      <form action="#" method="POST" className="mx-auto mt-12 max-w-3xl sm:mt-10">
        ...
        <div className="mt-10">
            <p className="text-gray-600 text-sm mt-2">Don&apos;t have an account? <Link to="/signup" className="font-semibold text-[#EB8942]" style={{color: "#FA5857"}}>Sign up</Link></p>
